...
public class TemperatureSeriesAnalysis {
    ...
    public double min() {
        ...
        for (int i=1; i < this.length; i++){
            if (min > this.temperatureSeries[i]){ min = this.temperatureSeries[i]; }
        }
        return min;
    }
    ...
    public double max() {
        ...
        for (int i=1; i < this.length; i++){
            if (max < this.temperatureSeries[i]){ max = this.temperatureSeries[i]; }
        }
        return max;
    }
    ...
    public double findTempClosestToValue(double tempValue) {
        ...
        for (int i=1; i < this.length; i++){
            if (Math.abs(closestToValue - tempValue) > Math.abs(
                this.temperatureSeries[i] - tempValue)){ closestToValue = this.temperatureSeries[i]; }
        }
